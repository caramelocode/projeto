...
public enum CPNotificacaoSB {
	_ID, _NOME, _TIPOENTIDADE, _ASSUNTO, _CONTEUDOHTML, _USUARIO, _TIPONOTIFICACAO, _STATUS, _DATAREGISTRONOTIFICACAO, _DATAEXPIRANOTIFICACAO, _DISPAROS, _CODIGOSELOCOMUNICACAO, _CODIGOENTIDADERELACIONADA, _RESPOSTAPOSTIVA, _DIALOGO;
