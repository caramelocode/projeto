 ...
 */
@Entity
@InfoObjetoSB(plural = "Objetos simples somente nome", tags = "Objeto simples apenas nome")
public class ExemploOpcaoSimples extends OpcaoDadoDinamico implements ComoTemIcone {
