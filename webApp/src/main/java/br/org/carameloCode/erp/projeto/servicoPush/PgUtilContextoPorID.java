...
import br.org.carameloCode.erp.projeto.config.PaginaAtual;
...
public class PgUtilContextoPorID implements Serializable {
    ...
    @Inject
    private PaginaAtual paginaatual;
    ...
    public Object getPaginaDoContexto() {
        ...
        if (request.getAttribute("respostaObj") != null) {
            ...
            ((ItfB_Pagina) paginaDoContextoCache).getRespostasDialogosTransitorios().put(r.getComunicacao().getCodigoSelo(), r);
        }
